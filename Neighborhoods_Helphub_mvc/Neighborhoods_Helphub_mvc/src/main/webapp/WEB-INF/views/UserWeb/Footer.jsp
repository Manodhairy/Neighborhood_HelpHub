      ...
      <div class="container">
        <div class="row py-4 my-5">
          ...
          <div class="col-md-6 col-lg-3">
            ...
            <form
              id="newsletterForm"
              class="form-style-5 opacity-10"
              action="https://www.okler.net/previews/porto/12.1.0/php/newsletter-subscribe.php"
              method="POST"
            >
              <div class="row">
              ...
              <div class="row">
                <div class="form-group col">
                  <button
                    class="btn btn-primary btn-rounded btn-px-4 btn-py-2 font-weight-bold"
                    type="submit"
                  >
                    SUBSCRIBE
                  </button>
