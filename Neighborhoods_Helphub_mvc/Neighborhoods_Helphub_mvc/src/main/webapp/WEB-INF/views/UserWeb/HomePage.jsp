				...
				<div class="owl-carousel-wrapper position-relative" style="height: 670px">
					...
					<div class="owl-carousel dots-inside dots-horizontal-center show-dots-hover nav-inside nav-inside-plus nav-dark nav-md nav-font-size-md show-nav-hover mb-0"
						...
						<div class="position-relative" data-dynamic-height="['670px','670px','670px','550px','500px']"
							style="
                background-image: url(resources/assets1/img/slides/slide-bg.jpg);
                background-size: cover;
                background-position: center;
                height: 670px;
              ">
							<div class="position-absolute top-0 right-0 w-50pct w-lg-auto">
								<img src="resources/assets1/img/slides/slide-devices.jpg" class="w-100 appear-animation"
									data-appear-animation="fadeInLeftDownShorter" data-appear-animation-delay="500"
									alt="" />
							</div>
							<div class="position-absolute top-50pct left-0 transform3dy-n50 w-50pct w-lg-auto">
								<img src="resources/assets1/img/slides/slide-laptop.jpg" class="w-100 appear-animation"
									data-appear-animation="fadeInRightDownShorter" data-appear-animation-delay="1000"
									alt="" />
							</div>
							<div class="position-absolute transform3dy-n50">
								<img src="resources/assets1/img/slides/slide-parallax-porto-symbol.png"
									class="w-75 appear-animation" data-appear-animation="fadeInRightDownShorter"
									data-appear-animation-delay="1500" alt="" style="top: 20%; left: -20%"
								...
								<div class="d-flex flex-column align-items-center justify-content-center h-100">
									<h3 class="position-relative text-color-light text-5 line-height-5 font-weight-medium px-4 mb-2 appear-animation"
										...
										<span
											...
											<img src="resources/assets1/img/slides/slide-title-border.png"
										...
										Welcome to
										<span class="position-relative">Neighborhoods HelpHub
											<span class="position-absolute left-50pct transform3dx-n50 top-0 mt-4"><img
													src="resources/assets1/img/slides/slide-blue-line.png"
													class="w-auto appear-animation"
									...
									<h1 class="text-color-light font-weight-extra-bold text-12 mb-3 appear-animation"
										...
										data-plugin-options="{'minWindowWidth': 0}">
										A community platform to connect, collaborate, and care for
										your neighbors.
									</h1>
						...
						<div class="position-relative overlay overlay-show overlay-op-8"
							data-dynamic-height="['670px','670px','670px','550px','500px']" style="
                background-image: url(resources/assets1/img/slides/slide-bg-2.jpg);
                background-size: cover;
                background-position: center;
                height: 670px;
              ">
									...
									<div class="col-lg-6">
										<div class="d-flex flex-column align-items-center">
											...
											<p class="text-4 text-color-light font-weight-light opacity-7 text-center mb-0"
												...
												Explore Events Organize charity drives, clean-up
												campaigns, and community meet-ups easily.
											</p>
										</div>
									</div>
								</div>
						...
						<div class="position-relative overlay overlay-color-primary overlay-show overlay-op-8"
							data-dynamic-height="['670px','670px','670px','550px','500px']" style="
                background-image: url(resources/assets1/img/slides/slide-bg-6.jpg);
                background-size: cover;
                background-position: center;
                height: 670px;
              ">
								...
								<div class="row justify-content-center align-items-center h-100">
									<div class="col-lg-6">
										<div class="d-flex flex-column align-items-center">
											...
											<h2 class="porto-big-title text-color-light font-weight-extra-bold mb-2"
												data-plugin-animated-letters
											...
											<p class="text-4 text-color-light font-weight-light text-center mb-0"
												...
												Discuss, share ideas, or report issues in the local
												community forum.
											</p>
										</div>
									</div>
						...
						<div class="row align-items-center">
							<div class="col-lg-8">
								<p>
									...
									<span>Find help, share resources, and make a difference in your
										neighborhood.</span>
								</p>
							</div>
							<div class="col-lg-4">
								<div class="get-started text-start text-lg-end">
									<a href="#" class="btn btn-dark btn-lg text-3 font-weight-semibold px-4 py-3">Get
										Started Now</a>
					...
					<div class="row text-center pt-3">
						<div class="col-md-10 mx-md-auto">
							...
							<p class="lead appear-animation" data-appear-animation="fadeInUpShorter"
								...
								Sunshine Heights is a next-generation neighborhood platform
								designed to connect residents, simplify communication, and build
								a smarter, safer, and more caring community.
							</p>
						</div>
					</div>
				</div>
							...
							<div class="row text-center">
								...
								<div class="col-lg-2 ms-lg-auto">
									<div class="process-image">
										<img src="resources/assets1/img/home/home-concept-item-1.png" alt="" />
										<strong>Strategy</strong>
									</div>
								</div>
								<div class="col-lg-2">
									<div class="process-image process-image-on-middle">
										<img src="resources/assets1/img/home/home-concept-item-2.png" alt="" />
										<strong>Planning</strong>
									</div>
								</div>
								<div class="col-lg-2">
									<div class="process-image">
										<img src="resources/assets1/img/home/home-concept-item-3.png" alt="" />
										<strong>Build</strong>
									</div>
								</div>
								<div class="col-lg-4 ms-lg-auto">
									<div class="project-image">
										<div id="fcSlideshow" class="fc-slideshow">
											<ul class="fc-slides">
												<li>
													<a href="portfolio-single-wide-slider.html" aria-label=""><img
															class="img-fluid"
															src="resources/assets1/img/projects/project-home-1.jpg"
															alt="" /></a>
												</li>
												<li>
													<a href="portfolio-single-wide-slider.html" aria-label=""><img
															class="img-fluid"
															src="resources/assets1/img/projects/project-home-2.jpg"
															alt="" /></a>
												</li>
												<li>
													<a href="portfolio-single-wide-slider.html" aria-label=""><img
															class="img-fluid"
															src="resources/assets1/img/projects/project-home-3.jpg"
															alt="" /></a>
												</li>
											</ul>
										</div>
								...
								<div class="col-sm-6">
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Manage all families, members, and help requests with
												real-time control. Track flat occupancy and community
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Residents can register, update family details, view
												events, and send help requests through a user-friendly
												interface.
											</p>
										</div>
									</div>
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Submit and manage emergency or assistance requests,
												helping neighbors and admins respond faster.
											</p>
										</div>
									</div>
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Integrated AI assistant to answer queries, suggest
												nearby events, and guide users through the system.
											</p>
										</div>
									</div>
								</div>
								...
								<div class="col-sm-6">
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Quickly find members, flats, or announcements using an
												intelligent search system with filters.
											</p>
										</div>
									</div>
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Role-based authentication for Admin and Member accounts
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Organize and promote community events or meetings
									...
									<div class="feature-box feature-box-style-2">
										...
										<div class="feature-box-info">
											...
											<p class="mb-4">
												Find nearby grocery stores, pharmacies, and essential
												shops with real-time distance and directions for
				...
				<div class="row text-center pt-4">
					<div class="col">
						...
						<h4 class="text-primary lead tall text-4">
							Join over <strong>5000+ users </strong> who trust and enjoy our
							services every day.
						</h4>
					</div>
				</div>

				<section class="section section-custom-map appear-animation lazyload"
					data-appear-animation="fadeInUpShorter" data-bg-src="img/map.png" style="
					...
					<section class="section section-default section-footer">
						<div class="container">
							<div class="row mt-5 appear-animation" data-appear-animation="fadeInUpShorter">
														...
														<div class="row">
															...
															<div class="col ps-1">
																<h4 class="text-primary text-4">
																	<a class="d-block" href="blog-post.html">Lorem ipsum
								...
								<div class="col-lg-6">
									<h2 class="font-weight-normal text-6 mb-4">
										<strong class="font-weight-extra-bold">What</strong>
										Client’s Say
									</h2>
									<div class="row">
												...
												<div class="col">
													<div class="testimonial testimonial-primary">
														<blockquote>
															<p class="mb-0">
																Lorem ipsum dolor sit amet, consectetur
																adipiscing elit. Donec hendrerit vehicula est,
																in consequat.
															</p>
														</blockquote>
														...
														<div class="testimonial-author">
															<div class="testimonial-author-thumbnail">
																<img src="resources/assets1/img/clients/client-1.jpg"
													...
													<div class="testimonial testimonial-primary">
														<blockquote>
															<p class="mb-0">
																Lorem ipsum dolor sit amet, consectetur
																adipiscing elit. Donec hendrerit vehicula est,
																in consequat. Lorem ipsum dolor sit amet,
																consectetur adipiscing elit. Donec hendrerit
