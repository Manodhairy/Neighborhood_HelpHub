                            ...
                            <div class="row mb-4 pb-2">
                                <div class="col">
                                    <p class="custom-font-secondary text-4 mb-4 appear-animation"
                                        data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">Lorem
                                        ipsum
                                        dolor sit amet, consectetur adipiscing elit. Proin bibendum ultricies nunc, eu
                                        interdum
                                        enim convallis pretium. </p>
                                    <p class="pb-1 mb-3 appear-animation" data-appear-animation="fadeInUpShorter"
                                        data-appear-animation-delay="500">Lorem ipsum dolor sit amet, consectetur
                                        adipiscing
                                        elit. Proin bibendum ultricies nunc, eu interdum enim convallis pretium. Quisque
                                        eu
                                        neque augue. Aliquam egestas nunc at efficitur faucibus. Praesent mauris eros,
                                        tincidunt
                                        id enim sodales, rhoncus malesuada ligula. </p>
                                    <p class="appear-animation" data-appear-animation="fadeInUpShorter"
                                        data-appear-animation-delay="700">Vivamus quis purus nec sapien pellentesque
                                        imperdiet.
                                        Nullam porttitor augue mi, sit amet luctus est tincidunt sed. Donec tempus
                                        bibendum ex,
                                        nec vehicula elit. </p>
                                </div>
                            </div>
                                            ...
                                            <div class="card custom-card-style-1">
                                                <div class="card-body text-center py-5 px-4">
                                                    ...
                                                    <p class="text-muted text-2">
                                                        ...
                                                        Status:
                                                        <span
                                                            class="${bill.status == 'PAID' ? 'text-success' : 'text-danger'}">
                                                            ${bill.status}
                                                        </span>
                                                    </p>
                    ...
                    <div class="col-md-9 col-lg-7 col-xl-9 text-center text-xl-start mb-4 mb-xl-0">
                        <h2 class="text-color-light font-weight-medium line-height-4 text-9 negative-ls-1 mb-2">For
                            <span class="font-weight-extra-bold custom-highlight-1 p-1 appear-animation"
                                ...
                                data-appear-animation-delay="300">Residential and Commercial</span> Cleaning
                        </h2>
                        <p
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <img id="qrImg" style="width:260px;height:260px;border:1px solid #ccc;border-radius:10px;">
                    ...
                    <form id="paymentForm" action="PaymentDone" method="post">
                        ...
                        <div class="mt-3 text-start">
                            ...
                            <input type="text" name="refNo" id="refNo" class="form-control w-80"
                                placeholder="Enter Payment Reference No" required>
                        </div>

                        <!-- SUBMIT BUTTON -->
                        <button type="submit" class="btn btn-success w-80 mt-3 ml-3">
                            Submit Payment
                        </button>
