                                    ...
                                    <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12">
                                        <div class="row">
                                            <c:forEach var="complaint" items="${complaintsList}">
                                                <div class="col-xl-4 col-lg-6">
                                                    <div class="card overflow-hidden">
                                                        <div
                                                            class="card-header d-flex align-items-center gap-2 border-bottom border-dashed bg-light-subtle">
                                                            ...
                                                            <div>
                                                                ...
                                                                <p class="mb-0 text-muted">Apartment:
                                                                    ${complaint.flat_no}</p>
                                                            </div>

                                                            <div class="ms-auto text-lg-end text-md-end text-sm-end">
                                                                <p class="mb-0 fw-medium text-danger">Status:
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="mt-3">
                                                                <div class="d-flex justify-content-between">
                                                                    <div>
                                                                        <p class="mb-0 fs-15 fw-medium">Complainant:
                                                                            ${complaint.fullName}</p>
                                                                        <p class="text-muted mb-0 fs-13">Flat No:
                                                                            ${complaint.flat_no} | Contact:
                                                                            ${complaint.mobile_no}</p>
                                                                        <p class="text-muted mb-0 fs-13">
                                                                            ${complaint.complaintDate}</p>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div>
                                                                    <a href="#!"
                                                                        class="badge bg-warning-subtle text-warning fw-medium">${complaint.complaintStatus}</a>
                                                                </div>
                                                                <!-- Resolution Section -->
                                                                <form action="resolveComplaint" method="post">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label fw-medium">Resolution
                                                                            Message</label>

                                                                        <textarea class="form-control"
                                                                            name="resolveMessage"
                                                                            placeholder="Write how this complaint was resolved or any update..."
                                                                            rows="3"></textarea>
                                                                    </div>
                                            ...
                                            <div class="offcanvas offcanvas-end" tabindex="-1"
                                                                        ...
                                                                        <div>
                                                                            <span class="d-flex h-100">
                                                                                ...
                                                                                <span class="flex-grow-1">
                                                                                    <span
                                                                                        class="d-flex h-100 flex-column rounded-2">
                                                                                        <span
                                                                        ...
                                                                        <div>
                                                                            <span class="d-flex h-100 flex-column">
                                                                                <span
                                                                                    ...
                                                                                    <span
                                                                                        class="d-block p-1 bg-dark-subtle rounded me-1"></span>
                                                                                    <span
                                                    ...
                                                    <div class="p-3 border-bottom border-dashed">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-3">
                                                                <div class="form-check card-radio">
                                                                    <input class="form-check-input" type="radio"
                                                                        ...
                                                                        value="light" />
                                                                    <label
                                                                        class="form-check-label p-0 avatar-lg w-100 bg-light"
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-check card-radio">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="data-topbar-color" id="topbar-color-brand"
                                                                        value="brand" />
                                                                    <label
                                                                        class="form-check-label p-0 avatar-lg w-100 bg-light"
                                                                        ...
                                                                        <span
                                                                            class="d-flex align-items-center justify-content-center h-100">
                                                                            <span
                                                                                class="p-2 d-inline-flex shadow rounded-circle bg-primary"></span>
                                                                        </span>
                                                                    </label>
                                                                </div>
                                                                <h5 class="fs-14 text-center text-muted mt-2">
                                                    ...
                                                    <div class="p-3 border-bottom border-dashed">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-3" style="--ct-dark-rgb: 64, 73, 84">
                                                                <div class="form-check sidebar-setting card-radio">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="data-menu-color" id="sidenav-color-dark"
                                                                        value="dark" />
                                                                    <label
                                                                        class="form-check-label p-0 avatar-lg w-100 bg-light"
                                                            ...
                                                            <div class="col-3">
                                                                <div class="form-check sidebar-setting card-radio">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="data-menu-color" id="sidenav-color-brand"
                                                                        value="brand" />
                                                                    <label
                                                                        class="form-check-label p-0 avatar-lg w-100 bg-light"
                                                                    ...
                                                                    <label class="form-check-label p-0 avatar-xl w-100"
                                                                        ...
                                                                        <span class="d-flex h-100">
                                                                            <span class="flex-shrink-0">
                                                                                <span class="d-flex h-100 flex-column">
                                                                                    <span
                                                                                        class="d-block p-1 bg-dark-subtle mb-1"></span>
                                                                                </span>
                                                                            </span>
                                                                            <span class="flex-grow-1">
                                                                                <span class="d-flex h-100 flex-column">
                                                ...
                                                <div
                                                    class="d-flex align-items-center gap-2 px-3 py-2 offcanvas-header border-top border-dashed">
                                                    <button type="button" class="btn w-50 btn-soft-danger"
                                                        id="reset-layout">
                                                        Reset
                                                    </button>
