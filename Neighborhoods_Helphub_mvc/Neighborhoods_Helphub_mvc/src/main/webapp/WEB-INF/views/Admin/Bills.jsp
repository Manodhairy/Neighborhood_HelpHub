                                ...
                                <c:forEach var="bill" items="${bills}">
                                    <form action="UpdateBill" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="houseRent" class="form-control"
                                                    value="${bill.houseRent}"></td>
                                            <td><input type="text" name="waterBill" class="form-control"
                                                    value="${bill.waterBill}"></td>
                                            <td><input type="text" name="electricityBill" class="form-control"
                                                    value="${bill.electricityBill}"></td>
                                            <td><input type="text" name="maintenanceCharges" class="form-control"
                                                    value="${bill.maintenanceCharges}"></td>
                                            <td><input type="text" name="dueDate" class="form-control"
                                                    value="${bill.dueDate}"></td>
                        ...
                        <div class="modal fade" id="addBillModal" tabindex="-1">
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    ...
                                    <form id="addBillForm" action="AddBill" method="post" novalidate>
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <input type="number" name="houseRent" class="form-control" min="0"
                                                        required>
                                                    <div class="invalid-feedback">Enter valid house rent</div>
                                                </div>

                                                <div class="col-md-6 mb-2">
                                                    <label>Water Bill</label>
                                                    <input type="number" name="waterBill" class="form-control" min="0"
                                                        required>
                                                    <div class="invalid-feedback">Enter valid water bill</div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <input type="number" name="electricityBill" class="form-control"
                                                        min="0" required>
                                                    <div class="invalid-feedback">Enter valid electricity bill</div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    ...
                                                    <input type="number" name="maintenanceCharges" class="form-control"
                                                        min="0" required>
                                                    <div class="invalid-feedback">Enter valid maintenance charges</div>
                                                </div>
