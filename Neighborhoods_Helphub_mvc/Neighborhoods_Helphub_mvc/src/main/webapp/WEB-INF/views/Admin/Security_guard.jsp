	            ...
	            <div class="page-container">
					...
					<div class="d-flex justify-content-center my-4">
					    <button type="button" class="btn btn-info px-4"
					            data-bs-toggle="modal" data-bs-target="#guardHistoryModal">
					         Guard History
					    </button>
					</div>
					...
					<div class="container mt-5">
					    <h2 class="mb-3">Security Guards List</h2>
					    ...
					    <table class="table table-bordered table-striped">
					        ...
					        <tbody>
					        <c:forEach var="g" items="${guardsList}">
					            <tr>
					...
					<div class="modal fade" id="guardHistoryModal" tabindex="-1" aria-hidden="true">
					    <div class="modal-dialog modal-lg modal-dialog-centered">
					        <div class="modal-content">

					            <div class="modal-header">
					                <h5 class="modal-title">Security Guard History</h5>
