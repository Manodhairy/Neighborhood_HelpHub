                                                        ...
                                                        <div class="col-lg-4 col-md-6">
                                                            <div class="card border shadow-sm rounded-4 h-100">
                                                                ...
                                                                <div class="p-3 d-flex align-items-center bg-light">
                                                                    <i
                                                                        class="ti ti-user-circle fs-3 me-2 text-primary"></i>
                                                                    <div>
                                                                ...
                                                                <div class="card-body">
                                                                    <h5 class="text-primary mb-2">${event.eventName}
                                                                    </h5>

                                                                    <ul class="list-unstyled small mb-3">
                                                                        <li><i
                                                                                class="ti ti-building me-2 text-success"></i><b>Organizer:</b>
                                                                            ${event.organizer}</li>
                                                                        <li><i
                                                                                class="ti ti-calendar-event me-2 text-warning"></i><b>Date:</b>
                                                                            ${event.eventDate}</li>
                                                                        <li><i
                                                                                class="ti ti-map-pin me-2 text-danger"></i><b>Venue:</b>
                                                                            ${event.venue}</li>
                                                                        <li><i class="ti ti-link me-2 text-info"></i><b>Online
                                                                                Link:</b>
                                                                            <c:if test="${not empty event.onlineLink}">
                                                                                <a href="#" target="_blank"
                                                                                    class="text-primary text-decoration-underline">Join</a>
                                                                            </c:if>
                                                                    ...
                                                                    <div class="border-top pt-2 mb-2 small text-muted">
                                                                        <i
                                                                            class="ti ti-message-circle me-1 text-secondary"></i>${event.message}
                                                                    </div>

                                                                    <!-- Action Buttons -->
                                                                    <div class="d-flex justify-content-between">
                                                                        <a href="approveEvent?eId=${event.eId}"
                                                                            class="btn btn-success btn-sm w-50 me-2 d-flex align-items-center justify-content-center">
                                                                            <i class="ti ti-check me-1"></i> Approve
                                                                        </a>
                                                                        <a href="rejectEvent?eId=${event.eId}"
                                                                            class="btn btn-danger btn-sm w-50 d-flex align-items-center justify-content-center">
